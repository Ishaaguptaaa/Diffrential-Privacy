...
# --- Load Trained Model (on fMNIST) ---
model = MNISTDPModel().to(device)
model.load_state_dict(torch.load("outputs_fmnist/fmnist_model/pytorch_model.bin", map_location=device))
model.eval()

# --- fMNIST Dataset (32x32 input size) ---
...
# --- Logging ---
log_path = "outputs_fmnist/mia_attack_accuracy.txt"
